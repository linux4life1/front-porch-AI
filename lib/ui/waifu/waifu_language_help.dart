...
class WaifuLanguageHelp extends StatefulWidget {
  const WaifuLanguageHelp({
    super.key,
    required this.langs,
    this.suggested = const {},
  });

  final WaifuLangRuntime langs;
  final Set<String> suggested;

  @override
  State<WaifuLanguageHelp> createState() => _WaifuLanguageHelpState();
}

class _WaifuLanguageHelpState extends State<WaifuLanguageHelp> {
  ...
  List<WaifuLangDoor> get _visible {
  ...
  Future<void> _toggle(WaifuLangDoor door, bool on) async {
    if (on) {
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: TextField(
              key: const Key('waifu-lang-search'),
              controller: _search,
            ...
            child: ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextField(
                    key: const Key('waifu-lang-custom-command'),
                    controller: _command,
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    key: const Key('waifu-lang-custom-add'),
