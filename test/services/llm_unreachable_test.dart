...
// LLM backend at all?" matcher — and LlmUnavailableException's user-facing
// toString. The matcher must recognize the same failure across platforms:
// Windows words connection-refused as "The remote computer refused the network
// connection" (errno 1225), macOS as "Connection refused" (errno 61), Linux as
// errno 111. Story pages and the web client surface these errors verbatim.
