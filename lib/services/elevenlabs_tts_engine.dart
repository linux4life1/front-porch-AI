      ...
      if (response.statusCode != 200) {
        ...
        try {
          ...
          if (response.statusCode == 401) {
            ...
            userMessage =
                'ElevenLabs credits exhausted. Your quota will reset at the start of your next billing cycle.';
            isQuota = true;
            ...
            userMessage =
                'ElevenLabs error: ${detail is Map ? detail['message'] ?? response.statusCode : response.statusCode}';
          }
        } catch (_) {
          userMessage = 'ElevenLabs error (${response.statusCode})';
        }

        throw ElevenLabsApiException(
          userMessage,
      ...
      _fetchedVoices = voices
          .map((v) {
            ...
            return TtsVoiceInfo(
              ...
              gender: gender.toLowerCase().contains('female')
                  ? 'Female'
