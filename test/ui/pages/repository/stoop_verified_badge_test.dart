...
//
// Widget + path-parser pins for the hub Twitter/X verified silhouette.
...
void main() {
  test('path string is the hub silhouette', () {
    expect(
      kStoopCheckPath,
  ...
  test('parseSvgPath fills the 22×22 viewBox', () {
    final simple = parseSvgPath('M0 0 L22 0 L22 22 L0 22 Z');
    expect(simple.getBounds(), const Rect.fromLTWH(0, 0, 22, 22));

    final b = kStoopCheckParsedPath.getBounds();
    expect(b.left, greaterThanOrEqualTo(-0.5));
    expect(b.top, greaterThanOrEqualTo(-0.5));
    expect(b.right, lessThanOrEqualTo(22.5));
    expect(b.bottom, lessThanOrEqualTo(22.5));
    expect(b.width, greaterThan(16));
