...
/// no git clone.
class WaifuSkillsPanel extends StatefulWidget {
  const WaifuSkillsPanel({super.key, required this.hub, this.onChanged});

  final WaifuSkillHub hub;
  final VoidCallback? onChanged;

  @override
  State<WaifuSkillsPanel> createState() => _WaifuSkillsPanelState();
}

class _WaifuSkillsPanelState extends State<WaifuSkillsPanel> {
  var _busy = false;
  String _flash = '';

  WaifuSkillHub get _hub => widget.hub;
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      key: const Key('waifu-skills-panel'),
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              _hub.destDir,
              key: const Key('waifu-skills-folder'),
              maxLines: 2,
          ...
          Align(
            ...
            child: TextButton.icon(
              key: const Key('waifu-skills-refresh'),
            ...
            Wrap(
              ...
              children: [
                for (final name in names)
                  Text(
                    name,
                    key: Key('waifu-skill-installed-$name'),
                    style: TextStyle(
                      fontSize: 11,
                      color: AppColors.textSecondary(context),
                    ),
  ...
  Widget _row(BuildContext context, WaifuMarketSkill s, Color amber) {
      ...
      child: Row(
        children: [
          ...
          if (on)
            ...
            TextButton(
              key: Key('waifu-skill-install-${s.name}'),
