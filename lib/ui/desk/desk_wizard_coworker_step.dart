...
class DeskWizardCoworkerStep extends StatefulWidget {
  ...
  @override
  State<DeskWizardCoworkerStep> createState() => _DeskWizardCoworkerStepState();
}

class _DeskWizardCoworkerStepState extends State<DeskWizardCoworkerStep> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            key: const Key('desk-coworker-search'),
            controller: _search,
...
class _CoworkerPick extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final file = deskCoworkerFace(context, card);
    return Material(
