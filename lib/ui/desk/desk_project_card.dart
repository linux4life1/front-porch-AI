...
import 'package:front_porch_ai/ui/desk/desk_delete_session_dialog.dart';
...
class DeskProjectCard extends StatefulWidget {
  const DeskProjectCard({
    super.key,
  ...
  @override
  State<DeskProjectCard> createState() => _DeskProjectCardState();
}

class _DeskProjectCardState extends State<DeskProjectCard> {
  var _hot = false;
    ...
    showMenu<String>(
      ...
      if (v == 'forget') {
        ...
        final ok = await showDialog<bool>(
          context: context,
          builder: (_) => DeskDeleteSessionDialog(project: widget.project),
        );
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned.fill(
                      child: InkWell(
                        key: widget.isNewest
                            ? const Key('desk-resume')
                            : Key('desk-project-${widget.project.folderName}'),
                        borderRadius: BorderRadius.circular(22),
                    ...
                    Positioned(
                      ...
                      child: IconButton(
                        key: Key(
                          'desk-project-menu-${widget.project.folderName}',
                        ),
