...
//
// Barrel for shared helpers for the built-in web server routes:
// JSON responses, request-body parsing, cookies, thumbnails, WS guards,
// trusted-peer client IP, and password step-up.
