...
enum WaifuNewSessionChoice { sameCharacter, pickNew }

/// After New session on a known folder: keep last coworker or pick another.
class WaifuNewSessionDialog extends StatelessWidget {
  const WaifuNewSessionDialog({super.key, required this.project});
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions: [
        TextButton(
          key: const Key('waifu-new-session-pick'),
          onPressed: () => Navigator.pop(context, WaifuNewSessionChoice.pickNew),
          child: Text(
        ...
        FilledButton(
          key: const Key('waifu-new-session-same'),
          style: FilledButton.styleFrom(
            backgroundColor: amber,
            foregroundColor: AppColors.onChaosAccent,
          ),
          onPressed: () =>
              Navigator.pop(context, WaifuNewSessionChoice.sameCharacter),
