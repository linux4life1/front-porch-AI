...
const kDeskInboxDir = '$kWaifuDotDir/inbox';

/// Save an attached PNG under the sit-down folder so the bubble can show it.
Future<String> deskSaveInboxPhoto(String folderRoot, Uint8List png) async {
  final dir = Directory(p.join(folderRoot, kDeskInboxDir));
