...
part of 'avatar_generation_panel.dart';

extension _AvatarGenerationPanelProgress on _AvatarGenerationPanelState {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            OutlinedButton.icon(
              onPressed: _c.canRegeneratePortrait
                  ? _c.regeneratePortrait
                  : null,
  ...
  Widget _stageRow(
    ...
    final done = _c.stage.index > at.index && _c.stage != AvatarRunStage.failed;
    ...
    return Column(
      ...
      children: [
        _stageRow(
          ...
          label:
              'Expression pack $done / $total (identity pinned to the '
              'portrait)',
