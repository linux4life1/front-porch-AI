...
class RealismStateInjection {
  ...
  /// The one sentence that lets a character use what they are already carrying.
  ///
  ...
  /// is on, something is actually biting, and they actually have something. Any
  ...
  /// smaller local one narrated the hunger and walked past the food in their
  /// own pocket, or went off to cook something. A person eats what is in their
  ...
  /// that nothing they have helps, which is the common answer.
  ///
  /// It does NOT suppress the feeling — they still show the hunger. It only
  /// stops them from overlooking what is already in their hand.
  static const _useWhatTheyHaveLine =
  ...
  String buildRealismStateInjection() {
    ...
    // showed. The block told a character they were starving four lines before
    // telling them what was in their pocket; it staged their physical position
    // dead last, after everything they might do from it; it said "they came in
    // not at their best" before any of the weather or needs that explain why;
    // and it split how-they-feel-about-people across the very top and the very
    // bottom with everything else in between.
    //
    ...
    //   2. their people  — who they are with and how they feel about them
    //   3. their word    — what they owe them
    //   4. who they are  — the standing facts that do not change with the hour
    //   5. how they are  — the volatile state, last, right next to the
    ...
    final fragments = <String>[
      ...
      // How they feel about the people in the room is one subject and was
      ...
      // ── 5. HOW THEY ARE RIGHT NOW ───────────────────────────────────────
      // Last, so the volatile state sits against the closing instruction to
      // express it. Their head first, then their body and what they have for it.
      //
      ...
      //
      // Placed by function rather than by category: what they carry is
      ...
      // by which point a small model had already sent them to the kitchen.
      //
      ...
      // The join closes the block. It reads backwards over what they have, what
      // they need and how their body is, so it must follow all three — and it
