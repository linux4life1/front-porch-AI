...
class DeskSlashMenu extends StatelessWidget {
  const DeskSlashMenu({
    super.key,
  ...
  final List<DeskSlashCommand> matches;
  final String prefix;
  final ValueChanged<DeskSlashCommand> onPick;
