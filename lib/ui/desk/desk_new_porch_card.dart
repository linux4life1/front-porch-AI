...
class DeskNewPorchCard extends StatefulWidget {
  const DeskNewPorchCard({super.key, required this.onTap, this.index = 0});

  final VoidCallback onTap;
  final int index;

  @override
  State<DeskNewPorchCard> createState() => _DeskNewPorchCardState();
}

class _DeskNewPorchCardState extends State<DeskNewPorchCard> {
  var _hot = false;
