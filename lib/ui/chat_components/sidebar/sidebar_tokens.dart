...
/// Character State stays up for group soft guests so the GUEST status
/// badge stays visible. Promote lives on the cast avatar strip, not
/// here. 1:1 scene guests still hide it (no member card; host realism
