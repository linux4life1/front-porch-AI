...
/// New-chat seed — startNewChat, startFreshChatWith, persistSessionPersona.
/// Chaos seed stays here (1:1 card-or-global and group flags-or-global).
extension ChatServiceSessionManage on ChatService {
  ...
  Future<void> startNewChat({String? personaId}) async {
    ...
    await _refreshCharacterForNewChat();
    ...
    // Both branches above cleared the record; put back what the CARDS say they
    // start with, so the fresh chat's greeting is drawn with their wardrobe
