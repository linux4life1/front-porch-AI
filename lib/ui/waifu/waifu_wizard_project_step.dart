...
class WaifuWizardProjectStep extends StatefulWidget {
  const WaifuWizardProjectStep({
    super.key,
  ...
  final WaifuFolderListing? listing;
  final bool loading;
  ...
  @override
  State<WaifuWizardProjectStep> createState() => _WaifuWizardProjectStepState();
}

class _WaifuWizardProjectStepState extends State<WaifuWizardProjectStep> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (hiddenCount > 0)
            SwitchListTile(
              key: const Key('waifu-show-hidden'),
              value: _showHidden,
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              key: const Key('waifu-use-folder'),
